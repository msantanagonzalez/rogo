        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 categoriaContainer">
              <img id="imagenTecnologia" src="Resources/images/carouselTecnologia.png" alt="..." class="imagenCategoria">
              <p class="textoCategoria text-center">Tecnologia &nbsp;<span class="icon-chipIcon iconosCategoria" aria-hidden="true"></p>
            </div>
          </div>
        </div>
        <!-- Fin Categoria -->
